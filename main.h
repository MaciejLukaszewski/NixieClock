...
#define NixieDigitB_Pin GPIO_PIN_7
...
#define BLUE_TIME_MODE_Pin GPIO_PIN_3
#define BLUE_TIME_MODE_GPIO_Port GPIOB
#define GREEN_ALARM_MODE_Pin GPIO_PIN_4
#define GREEN_ALARM_MODE_GPIO_Port GPIOB
#define RED_ALARM_OC_Pin GPIO_PIN_5
#define RED_ALARM_OC_GPIO_Port GPIOB
